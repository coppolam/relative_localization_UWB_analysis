%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% experiment_2MAVs_MCS.m
%
% Data analysis for leader-follower the experiment with the **2 MAVs using the Motion Caputure Sytem** (except range, which was measured with Ultra Wideband).
