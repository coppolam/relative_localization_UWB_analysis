...
file = strcat('..\..\..\Figures\NDI_experiments\leader_follower_traj_GPS.eps');
...
file = strcat('..\..\..\Figures\NDI_experiments\leader_follower_plocerr_GPS.eps');
...
file = strcat('..\..\..\Figures\NDI_experiments\leader_follower_xcomp_GPS.eps');
...
ymin = -4; ymax = 7; ytick=2;
xmin = 50; xmax = 100; xtick = 10;
file = strcat('..\..\..\Figures\NDI_experiments\leader_follower_ycomp_GPS.eps');
...
% figure;
% hold on;
% plot(newt,cutdata1{:,'track_ax'});
%% Messaging rate
dtv2 = diff(newt1);
save('dtv2drones','newt1','dtv2')
h=figure;
plot(dtv)
