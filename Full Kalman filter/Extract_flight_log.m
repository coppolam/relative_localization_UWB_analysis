function [ time,own_x,own_y,own_z,own_vx,own_vy,own_vz,oth_vx,oth_vy,oth_z,range_m,rel_x_kal,rel_y_kal,own_vx_kal,own_vy_kal,oth_vx_kal,oth_vy_kal,rel_h_kal] = Extract_flight_log( filepath )
%EXTRACT_FLIGHT_DATA Summary of this function goes here
%   Detailed explanation goes here
addpath(filepath);
tabvars = extractData('Choose log file');
